...
// Close the activity
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        // Proceed with moving to the first row of the cursor and reading data from
